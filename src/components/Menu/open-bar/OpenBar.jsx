      ...
      <div className="Container">
        ...
        <main className={classes.CocktailsMain}>
          ...
          <div className={classes.SubMenuLastDiv}>
            ...
            <p className={classes.SubMenuBeerPLast}>- see bartender for alcoholic options -</p>
            <h3 className={classes.SubMenuH3}>Non-Alcoholic</h3>
            <p className={classes.SubMenuBeerP}>st. pauli girl</p>
          </div>
        </main>
      </div>
    </div>
